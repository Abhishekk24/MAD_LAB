...
class WorkoutScheduleView extends StatefulWidget {
  ...
  const WorkoutScheduleView({Key? key, required this.onTimeSelected}) : super(key: key);
...
void setDayEventWorkoutList() {
  ...
  if (selectDayEventArr.isNotEmpty) {
    _notifyParent(selectDayEventArr.first);
  }
}

void _notifyParent(Map selectedEvent) {
  widget.onTimeSelected(selectedEvent["date"]);
}
